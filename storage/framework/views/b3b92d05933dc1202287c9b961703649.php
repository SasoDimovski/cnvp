<?php $__env->startSection('content'); ?>
    ...
    ?>
    <?php echo $__env->make('projects::projects._include-functions.function-highlight-search', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-md-4 col-lg-3 col-xl-3">
                                    ...
                                    $x = app('request')->input($name) ? ('    x') : null;
                                    ?>
                                    <i class="fas fa-calendar text-success"></i> <label class="control-label"><?php echo e($desc); ?>
                            ...
                            <div class="dataTables_wrapper dt-bootstrap4">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-5">
                                        ...
                                        <strong> <span
                                                class="badge badge-warning"><?php echo e($projects->firstItem()); ?></span></strong>
                                        <?php echo e(__('global.to')); ?>

                                        <strong> <span
                                                class="badge badge-warning"><?php echo e($projects->lastItem()); ?></span></strong>
                                        (<?php echo e(__('global.sum')); ?>

                                        <strong> <span
                                                class="badge badge-danger"><?php echo e($projects->total()); ?></span></strong>
                                        ...
                                        <table id="example2" class="table_grid">
                                            ...
                                            <tr>
                                                ...
                                                <th class="sortable <?php echo e($style_acs_desc); ?>" style="white-space: nowrap; width: 1px;"
                                                    ...
                                                    ?>
                                                <th class="sortable <?php echo e($style_acs_desc); ?>" style="white-space: nowrap; width: 1px;"
                                                    onclick="orderBy('<?php echo e($column_name); ?>','<?php echo e($sort); ?>')"><i class="fas fa-calendar"></i> <?php echo e($column_desc); ?>&nbsp;&nbsp;&nbsp;&nbsp;</th>
                                                ...
                                                <th class="sortable <?php echo e($style_acs_desc); ?>" style="white-space: nowrap; width: 1px;"
                                                    ...
                                                    $column_desc = __('projects.assignments');
                                                    $query_sort = request()->query('sort');
                                                    $style_acs_desc = match(true) {
                                                        $query_sort == 'asc' && $order == $column_name => 'asc',
                                                        $query_sort == 'desc' && $order == $column_name => 'desc',
                                                ...
                                                <th class="sortable <?php echo e($style_acs_desc); ?>" style="white-space: nowrap; width: 1px;"
                                                    ...
                                                    $column_desc = __('projects.activities');
                                                    $query_sort = request()->query('sort');
                                                    $style_acs_desc = match(true) {
                                                        $query_sort == 'asc' && $order == $column_name => 'asc',
                                                        $query_sort == 'desc' && $order == $column_name => 'desc',
                                                ...
                                                <th style="white-space: nowrap; width: 1px;"><i class="fas fa-archive"  title="<?php echo e(__('global.expired_status')); ?>"></i>
                                                </th>
                                            ...
                                            <?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    ?>
                                                <tr <?php if($isExpired): ?> style="color: #BD362F" <?php elseif($project->active == 0): ?> style="color: #cccccc"  <?php endif; ?> >

                                                    <td class="text-center"><?php echo highlightSearch($project->id, 'id', $global_style_search); ?></td>
                                                    <td  class="target-cell"> </td>
                                                    <td><?php echo highlightSearch($project->name, 'name', $global_style_search); ?></td>
                                                    <td><?php echo highlightSearch($project->code, 'code', $global_style_search); ?></td>
                                                    <td class="text-center" title="<?php echo date("d.m.Y  H:i:s", strtotime($project->start_date )); ?>"><?php echo highlightSearch(date("d.m.Y", strtotime($project->start_date )), 'start_date', $global_style_search); ?></td>
                                                    <td class="text-center" title="<?php echo date("d.m.Y  H:i:s", strtotime($project->end_date )); ?>"><?php echo date("d.m.Y", strtotime($project->end_date )); ?></td>
                                                    ...
                                                    <td class="text-center"><?php echo e($project->assignments_count); ?></td>
                                                    <td class="text-center"><?php echo e($project->activities_count); ?></td>
                                                    <td class="text-center"><?php echo e($project->records_count); ?></td>
                                                    ...
                                                    <td  class="source-cell">
                                                        <div class="btn-group btn-group-sm">
                                                            ...
                                                            <button class="btn btn-info"
                                                                    onclick="getContentID('<?php echo e($url_show.'/'. $project->id); ?>','ModalShow','<?php echo e($module->title); ?>')">
                                                                <i class="fas fa-eye"
                                                                   title="<?php echo e(__('global.show_hint')); ?>"></i></button>
                                                            

                                                                
                                                                <a href="<?php echo e($url_edit.'/'.$project->id.'?'.$query); ?>"
                                                                ...
                                                                <a href="#" class="btn btn-danger modal_warning"
                                                                   ...
                                                                   data-url="<?php echo e($url_delete.'/'.$project->id.'?'.$query); ?>"

                                                                   data-content_l="id: <?php echo e($project->id); ?>, "
                                                                   data-content_b="<?php echo e($project->name); ?>, "
                                                                   data-content_sub_l="<?php echo e($project->code); ?>"
                                                                   data-content_sub_b=""
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <div class="pagination pagination-sm float-right">
                                            <?php echo e($projects->withQueryString()->links('pagination::bootstrap-4')); ?>
...
<?php echo $__env->make('admin/master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/Modules/Projects/resources/views/projects/index.blade.php ENDPATH**/ ?>