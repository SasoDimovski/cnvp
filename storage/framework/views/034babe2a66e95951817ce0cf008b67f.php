...
$url_store = $url . '/store-record/'. $id_user;
$url_update = $url . '/update-record/'.$id.'/'.$id_user;
$url_action = !empty($id) ? $url_update : $url_store;

$url_return = $url. '/index-records/'. $id_user;
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <div class="custom-control custom-checkbox">
                                    <input class="custom-control-input" type="checkbox" id="lockrecord"
                                           name="lockrecord"
                                           value="1" <?php if($lockrecord==1): ?>
                                        <?php echo e('checked'); ?>

                                        <?php endif; ?> >
                                    <label for="lockrecord"
                                           class="custom-control-label"
                                           id="active"><?php echo e(__('users.records.lockrecord')); ?> </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <div class="custom-control custom-checkbox">
                                    <input class="custom-control-input" type="checkbox" id="approvedby"
                                           name="approvedby"
                                           value="1" <?php if($approvedby): ?>
                                        <?php echo e('checked'); ?>

                                        <?php endif; ?> >
                                    <label for="approvedby"
                                           class="custom-control-label"
                                           id="active"><?php echo e(__('users.records.approved')); ?> </label>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-12">
                        ...
                        $input_value = $date;
                        $input_name = 'date_';
                        $input_desc = __('users.records.date').' *';
                        $input_maxlength = 100;
                        $input_required= 'required';
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-4 col-lg-5 col-xl-12">
                            ...
                            <select class="form-control"
                                    ...
                                    fillDropdown('<?php echo e($url_fill_dropdown); ?>/get-assignments/'+encodeURIComponent(this.value)+'/'+<?php echo e(Auth::id()); ?>, 'assignments_dropdown')"
                                ...
                                <?php if(count($projects) > 0): ?>
                                    ...
                                    <?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option
                                            value="<?php echo e($project->id); ?>" <?php echo e(($project->id==$id_project)? 'selected' : ''); ?>><?php echo e($project->name); ?>
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-4 col-lg-5 col-xl-5">
                            <?php
                            $name = 'id_assignment';
                            $desc = __('users.records.assignment');
                            ?>
                            <label class="text-red" for="<?php echo e($name); ?>"><?php echo e($desc); ?> *</label>
                        ...
                        <div class="col-sm-12 col-md-4 col-lg-5 col-xl-5">
                            <?php
                            $name = 'id_activity';
                            $desc = __('users.records.activity');
                            ?>
                            <label class="text-red" for="<?php echo e($name); ?>" ><?php echo e($desc); ?> *</label>
                        ...
                        <div class="col-sm-2">
                            <?php
                            $name = 'duration';
                            $desc = __('users.records.duration');
                            ?>
                            <div class="form-group">
...
<script>
    ...
    lockedDays = lockedDays.map(date => date.split(' ')[0]);
...
<?php /**PATH /var/www/Modules/Users/resources/views/users/edit-record.blade.php ENDPATH**/ ?>