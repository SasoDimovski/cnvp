<?php $__env->startSection('content'); ?>
                ...
                <div class="hr-top" >
                    <div class="hr-top-label" ><?php echo e(__('auth.forgotten')); ?></div>
                </div>
                <label for="tab-1" class="tab"><?php echo e(config('app.TITLE')); ?></label>
                <form action="<?php echo e(url('/forgotten-post')); ?>" method="post">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" id="hash" name="hash" value="<?php echo e($hash); ?>">
                    <div class="group">
                        <label for="new-password" class="label"><?php echo e(__('auth.forgotten.new_password')); ?></label>
                        <input type="password" class="input" id="new-password" name="new-password" maxlength="30" placeholder="" >
                    </div>
                    <div class="group">
                        <label for="confirm-password" class="label"><?php echo e(__('auth.forgotten.confirm_new_password')); ?></label>
                        ...
                        <div class="label" style="width: 100%;text-align: right;" id="toggle_img"><img
                                ...
                                onclick="toggleSwap()"
                                title="<?php echo e(__('auth.forgotten.toggle')); ?>"
                            ></div>
                    </div>
                    <div class="group">
                        <input type="submit" class="button" value="<?php echo e(__('auth.forgotten.enter')); ?>">
                    </div>
...
<?php echo $__env->make('auth::master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/Modules/Auth/resources/views/auth/forgotten.blade.php ENDPATH**/ ?>