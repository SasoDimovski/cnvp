                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="select2bs4" style="width: 100%" multiple="multiple" id="<?php echo e($input_name); ?>" name="<?php echo e($input_name); ?>" autocomplete="off" <?php echo e($input_readonly); ?>>
                                                    <?php if(count($countries) > 0): ?>
                                                        <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option
                                                                value="<?php echo e($country->id); ?>"
                                                                <?php echo e(in_array($country->id, old('id_country', array_column($myArray, 'id'))) ? 'selected' : ''); ?> <?php echo e($input_readonly); ?>>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" id="id_expiration_time" name="id_expiration_time"
                                                       value="<?php echo e($id_expiration_time); ?>">
                                                <input type="text" id="" name="" class="form-control"
                                                       value="<?php echo e($user->expirationTime->name); ?>"
                                                       readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" id="user_type" name="user_type"
                                                       value="<?php echo e($user_type); ?>">
                                                <input type="text" id="" name="" class="form-control"
                                                       value="<?php echo e(collect(config('users.user_type'))->where('value', $user_type)->first()['name'] ?? ''); ?>"
                                                       readonly>
                                            </div>
                                        </div>
...
<?php echo $__env->make('admin/master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/Modules/User/resources/views/user/edit.blade.php ENDPATH**/ ?>