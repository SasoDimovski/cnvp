<?php $__env->startSection('content'); ?>
    ...
    $listing = app('request')->input('listing', config('countries.pagination'));
    ...
    $url_base= 'admin/'.$lang.'/'.$id_module.'/countries/';
    ...
    ?>
    <?php echo $__env->make('countries::countries._include-functions.function-highlight-search', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            ...
                            <div class="dataTables_wrapper dt-bootstrap4">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-5">
                                        ...
                                        <strong> <span
                                                class="badge badge-warning"><?php echo e($countries->firstItem()); ?></span></strong>
                                        <?php echo e(__('global.to')); ?>

                                        <strong> <span
                                                class="badge badge-warning"><?php echo e($countries->lastItem()); ?></span></strong>
                                        (<?php echo e(__('global.sum')); ?>

                                        <strong> <span
                                                class="badge badge-danger"><?php echo e($countries->total()); ?></span></strong>
                                ...
                                <div class="row">
                                        ...
                                        <table id="example2" class="table_grid">
                                            ...
                                            <tr>
                                                ...
                                                <th class="sortable <?php echo e($style_acs_desc); ?>"
                                                    ...
                                                    <?php
                                                    $column_name = 'code_s';
                                                    $column_desc = __('countries.code_s');
                                                    $query_sort = request()->query('sort');
                                                    $style_acs_desc = match(true) {
                                                        $query_sort == 'asc' && $order == $column_name => 'asc',
                                                        $query_sort == 'desc' && $order == $column_name => 'desc',
                                                ...
                                                <th class="sortable <?php echo e($style_acs_desc); ?>" style="white-space: nowrap; width: 1px;"
                                                    ...
                                                    <?php
                                                    $column_name = 'users';
                                                    $column_desc = __('countries.users');
                                                    $query_sort = request()->query('sort');
                                                    $style_acs_desc = match(true) {
                                                        $query_sort == 'asc' && $order == $column_name => 'asc',
                                                        $query_sort == 'desc' && $order == $column_name => 'desc',
                                                ...
                                                <th class="sortable <?php echo e($style_acs_desc); ?>" style="white-space: nowrap; width: 1px;"
                                                    ...
                                                    <?php
                                                    $column_name = 'records';
                                                    $column_desc = __('countries.records');
                                                    $query_sort = request()->query('sort');
                                                    $style_acs_desc = match(true) {
                                                        $query_sort == 'asc' && $order == $column_name => 'asc',
                                                        $query_sort == 'desc' && $order == $column_name => 'desc',
                                            ...
                                            <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                        <tr>
                                                    <td><?php echo highlightSearch($country->id, 'id', $global_style_search); ?></td>
                                                    <td><?php echo highlightSearch($country->name, 'name', $global_style_search); ?></td>
                                                    <td class="text-center"><?php echo e($country->code_s); ?></td>
                                                    <td class="text-center"><?php echo e($country->users_count); ?></td>
                                                    <td class="text-center"><?php echo e($country->records_count); ?></td>
                                                    <td>
                                                        <div class="btn-group btn-group-sm">
                                                            
                                                            <button class="btn btn-info"
                                                                    onclick="getContentID('<?php echo e($url_show.'/'. $country->id); ?>','ModalShow','<?php echo e($module->title); ?>')">
                                                                <i class="fas fa-eye"
                                                                   title="<?php echo e(__('global.show_hint')); ?>"></i></button>
                                                            

                                                                
                                                                <a href="<?php echo e($url_edit.'/'.$country->id.'?'.$query); ?>"
                                                                ...
                                                                <a href="#" class="btn btn-danger modal_warning"
                                                                   ...
                                                                   data-url="<?php echo e($url_delete.'/'.$country->id.'?'.$query); ?>"

                                                                   data-content_l="id: <?php echo e($country->id); ?>, "
                                                                   data-content_b="<?php echo e($country->name); ?>, "
                                                                   data-content_sub_l="<?php echo e($country->code); ?>"
                                                                   data-content_sub_b=""
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <div class="pagination pagination-sm float-right">
                                            <?php echo e($countries->withQueryString()->links('pagination::bootstrap-4')); ?>
...
<?php echo $__env->make('admin/master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/Modules/Countries/resources/views/countries/index.blade.php ENDPATH**/ ?>