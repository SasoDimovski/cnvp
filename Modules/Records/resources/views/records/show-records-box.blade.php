                ...
                <div>
                    ...
                    <div class="timeline-item">
                        <div class="timeline-header">
                            ...
                            <div class="row" style="height: 7px"></div>
                            <i class="fas fa-calendar text-info"></i> <strong>{{__('records.date')}}</strong>: {{ $date }}
                            <div class="row" style="height: 7px"></div>
                            ...
                            @endif
                            <div class="row" style="height: 7px"></div>
                            <strong>{{__('records.dateofapproval')}}</strong> <i class="fas fa-calendar text-info"></i> : {{$dateofapproval}}
                            <div class="row" style="height: 7px"></div>
