        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>
                            <i class="fa {{$module->design->icon}}"></i> {{$module->title}} / {{__('users.records')}}
                            <a class="btn btn-danger btn-sm" href="#" onclick="getContentID('{{$url_create}}','ModalShow','{{ __('users.records.title_working_hours',['date'=>$year_selected]) }}')">{{__('global.new_record')}}</a></h1>
                    </div>
                    <div class="col-sm-6">
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-12">
                       <strong class="text-danger">{{$user->name}} {{$user->surname}}, {{$user->username}}, id: {{$user->id}}, {{$user->email}}</strong>
                    </div>
                </div>
                        ...
                        @if(count($records) > 0)
                            ...
                            <div class="dataTables_wrapper dt-bootstrap4">
                                ...
                                <form class="needs-validation" role="form" id="form_edit" name="form_edit"
                                      action="{{$url_lock_approve}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <table id="example2" class="table_grid">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center text-danger">
                                                        <input class="" type="checkbox"
                                                               ...
                                                               @if($records->lock == 1) checked @endif>
                                                    ...
                                                    <td class="text-center text-danger">
                                                        ...
                                                        <input class="" type="checkbox"
                                                               ...
                                                               @if($records->approved == 1) checked @endif>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    {{-- ========================================================================--}}
                                                    <th style="white-space: nowrap; width: 1px;">{{__('users.records.locked_year')}}</th>
                                                    {{-- ========================================================================--}}
                                                    <th style="white-space: nowrap; width: 1px;">{{__('users.records.lockrecord')}}</th>
                                                    {{-- ========================================================================--}}
                                                    <th style="white-space: nowrap; width: 1px;">{{__('users.records.approved')}}</th>
                                                    {{-- ========================================================================--}}
                                                ...
                                                @foreach($records as $record)
                                                    ...
                                                    <tr @if($record->activities->type==1) style="color: #BD362F" @endif>
                                                        ...
                                                        <td>{!! highlightSearch( $record->activities->name, 'activity', $global_style_search) !!}</td>
                                                        ...
                                                        <td class="text-center">
                                                            <input type="hidden" name="records[{{ $record->id }}]"
                                                                   value="0">
                                                            <input type="checkbox"
                                                                   class="lockrecord"
                                                                   data-master="lock"
                                                                   id="lockrecord_{{ $record->id }}"
                                                                   name="records[{{ $record->id }}]"
                                                                   value="1"
                                                                   @if($record->lockrecord == 1) checked @endif>
                                                        </td>
                                                        <td class="text-center">
                                                            <input type="checkbox"
                                                                   class="approvedby"
                                                                   data-master="approved"
                                                                   id="approvedby_{{ $record->id }}"
                                                                   name="approvedby[{{ $record->id }}]"
                                                                   value="1"
                                                                   @if($record->approvedby) checked @endif>
                                                        </td>
                                                        <td  class="source-cell">
                                                            <div class="btn-group btn-group-sm">
                                                                ...
                                                                <button class="btn btn-info"
                                                                        type="button"
                                                                        onclick="getContentID('{{$url_show.'/'. $record->id}}','ModalShow','{{ __('users.records.records') }}')">
                                                                    <i class="fas fa-eye"
                                                                ...
                                                                <a href="#"
                                                                   ...
                                                                   onclick="getContentID('{{$url_edit.'/'.date("Y", strtotime($record->date)).'/'.$record->id.'/'.$user->id.'?'.$query}}','ModalShow','{{ __('users.records.records') }}')"
                                                                ><i
                                                                        class="fa fa-edit"
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right">
                                                        <strong>{{__('users.records.total')}}:</strong></td>
