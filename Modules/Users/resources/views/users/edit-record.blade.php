                            ...
                            <div class="form-group">
                                <div class="custom-control custom-checkbox">
                                    <input class="custom-control-input" type="checkbox" id="lockrecord"
                                           name="lockrecord"
                                           value="1" @if($lockrecord==1)
                                        {{'checked'}}
                                        @endif >
                                    <label for="lockrecord"
                                           class="custom-control-label"
                                           id="active">{{__('users.records.lockrecord')}} </label>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                <div class="custom-control custom-checkbox">
                                    <input class="custom-control-input" type="checkbox" id="approvedby"
                                           name="approvedby"
                                           value="1" @if($approvedby)
                                        {{'checked'}}
                                        @endif >
                                    <label for="approvedby"
                                           class="custom-control-label"
                                           id="active">{{__('users.records.approved')}} </label>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-4 col-lg-5 col-xl-12">
                            ...
                            <select class="form-control"
                                    ...
                                    fillDropdown('{{ $url_fill_dropdown }}/get-assignments/'+encodeURIComponent(this.value)+'/'+{{ Auth::id() }}, 'assignments_dropdown')"
                                ...
                                @if(count($projects) > 0)
                                    ...
                                    @foreach($projects as $project)
                                        <option
                                            value="{{$project->id}}" {{ ($project->id==$id_project)? 'selected' : '' }}>{{$project->name}}
                                           {{-- ({{$project->id}}, {!! date("d.m.Y  H:i:s", strtotime($project->end_date))!!})--}}
                                        </option>
                                    @endforeach
                                @endif
                            </select>
