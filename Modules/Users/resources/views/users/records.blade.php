...
@section('content')
    ...
    $url_base = $url . '/records/';

    $url_create = url($url_base . 'create/'.$year_selected.'/'.$user->id.'?'.$query);
    $url_edit = url($url_base . 'edit');
    $url_show = url($url_base . 'show');
    $url_delete = url($url_base . 'delete');


    $url_lock_approve = url($url_base . 'lock-approve/' . $user->id);
    $url_return = url($url_base . $user->id);
    ...
    //  $id_country_selected = app('request')->input('id_country') ? app('request')->input('id_country') : 'all';
    $total = 0;
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1><i class="fa fa-user"></i> {{$user->id}}, {{$user->name}} {{$user->surname}}
                            , {{$user->username}}
                                                        ...
                                                        <td>
                                                            <div class="btn-group btn-group-sm">
                                                                ...
                                                                <a href="#"
                                                                   ...
                                                                   onclick="getContentID('{{$url_edit.'/'.$record->id.'/'.$user->id.'?'.$query}}','ModalShow','{{ __('users.records.records') }}')"
                                                                ><i
                                                                        class="fa fa-edit"
