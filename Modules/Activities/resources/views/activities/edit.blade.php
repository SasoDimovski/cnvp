...
@section('content')
    ...
    $url_store = url('admin/' . $lang . '/' . $id_module . '/activities/store/');
    $url_update = url('admin/' . $lang . '/' . $id_module . '/activities/update/' . $id);
    $url_action = !empty($id) ? $url_update : $url_store;
    $url_return = url('admin/' . $lang . '/' . $id_module . '/activities/edit/' . $id);
                                    ...
                                    @if(isset($activity))
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                    ...
                                                    $input_desc = __('activities.insertedby');
                                                    $input_maxlength = 100;
                                                    $input_readonly= 'readonly';
                                                    $input_css= 'text';
                                                    ?>
                                                <div class="form-group">
                                                    <label for="{{$input_name}}" class="{{$input_css}}">{{$input_desc}}: <b class="text-warning">{{$insertedby_}}</b></label>
                                                    <input type="text" id="{{$input_name}}" name="{{$input_name}}" class="form-control" value="{{$input_value}}"
                                                           maxlength="{{$input_maxlength}}" {{$input_readonly}}>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-6">
                                                    ...
                                                    $input_desc = __('activities.updatedby');
                                                    $input_maxlength = 100;
                                                    $input_readonly= 'readonly';
                                                    $input_css= 'text';
                                                    ?>
                                                <div class="form-group">
                                                    <label for="{{$input_name}}" class="{{$input_css}}">{{$input_desc}}: <b class="text-warning">{{$updatedby_}}</b></label>
                                                    <input type="text" id="{{$input_name}}" name="{{$input_name}}" class="form-control" value="{{$input_value}}"
                                                           maxlength="{{$input_maxlength}}" {{$input_readonly}}>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-6">
                                                    ...
                                                    $input_desc = __('activities.dateinserted');
                                                    $input_maxlength = 100;
                                                    $input_readonly= 'readonly';
                                                    $input_css= 'text';
                                                    ?>
                                            ...
                                            <div class="col-sm-6">
                                                    ...
                                                    $input_desc = __('activities.dateupdated');
                                                    $input_maxlength = 100;
                                                    $input_readonly= 'readonly';
                                                    $input_css= 'text';
                                                    ?>
