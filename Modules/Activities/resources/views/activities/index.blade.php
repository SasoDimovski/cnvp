...
@section('content')
    ...
    ?>
    @include('activities::activities._include-functions.function-highlight-search')
                            ...
                            <div class="dataTables_wrapper dt-bootstrap4">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-5">
                                        {{__('global.show_from')}}
                                        <strong> <span
                                                class="badge badge-warning">{{ $activities->firstItem() }}</span></strong>
                                        {{__('global.to')}}
                                        <strong> <span
                                                class="badge badge-warning">{{$activities->lastItem() }}</span></strong>
                                        ({{__('global.sum')}}
                                        <strong> <span
                                                class="badge badge-danger">{{ $activities->total() }}</span></strong>
                                        {{__('global.records')}})
                                    </div>
                                </div>
                                <!-- Page end =============================================================================================== -->
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <table id="example2" class="table_grid">
                                            ...
                                            @foreach($activities as $activity)
                                                    ...
                                                    @endphp
                                                <tr>
                                                    <td>{!! highlightSearch($activity->id, 'id', $global_style_search) !!}</td>
                                                    <td>{!! highlightSearch($activity->name, 'name', $global_style_search) !!}</td>
                                                    ...
                                                    <td class="text-center">{{ $activity->projects_count   }}</td>
                                                    <td class="text-center">{{ $activity->records_count    }}</td>
                                                    <td>
                                                        <div class="btn-group btn-group-sm">
                                                            {{-------------------------------------------------------------------------------------------------------}}
                                                            <button class="btn btn-info"
                                                                    onclick="getContentID('{{$url_show.'/'. $activity->id }}','ModalShow','{{ $module->title}}')">
                                                                <i class="fas fa-eye"
                                                                   title="{{__('global.show_hint')}}"></i></button>
                                                            {{-------------------------------------------------------------------------------------------------------}}

                                                                {{-------------------------------------------------------------------------------------------------------}}
                                                                <a href="{{$url_edit.'/'.$activity->id.'?'.$query }}"
                                                                ...
                                                                <a href="#" class="btn btn-danger modal_warning"
                                                                   ...
                                                                   data-url="{{$url_delete.'/'.$activity->id.'?'.$query }}"

                                                                   data-content_l="id: {{$activity->id}}, "
                                                                   data-content_b="{{ $activity->name}}, "
                                                                   data-content_sub_l="{{ $activity->code}}"
                                                                   data-content_sub_b=""
