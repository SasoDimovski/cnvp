        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>
                            <i class="fa {{$module->design->icon}}"></i> {{$module->title}} / <span class="text-info">{{ __('reports.type_detail')}}</span>
                                            ...
                                            <table id="example2" class="table_grid">
                                                ...
                                                <tr>
                                                  {{--   ========================================================================--}}
                                                    ...
                                                    {{-- ========================================================================--}}
                                                    <th style="white-space: nowrap; width: 1px;"><i class="fas fa-lock" title="{{__('reports.locked')}}"></i> </th>
                                                    {{-- ========================================================================--}}
                                                    <th style="white-space: nowrap; width: 1px;"><i class="fas fa-check" title="{{__('reports.approved')}}"></i></th>
                                                    {{-- ========================================================================--}}
                                                </tr>
                                                    ...
                                                    <tr @if($record->activities->type==1) style="color: #BD362F" @endif >
                                                        ...
                                                        <td class="text-center">
                                                            @if($record->lockrecord== 1)
                                                                <i class="fas fa-lock"
                                                                   title="{{__('reports.locked_record')}}"></i>
                                                            @endif
                                                        </td>
                                                        <td class="text-center">
