...
@section('content')
    ...
    ?>
    @include('countries::countries._include-functions.function-highlight-search')
                            ...
                            <div class="dataTables_wrapper dt-bootstrap4">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-5">
                                        {{__('global.show_from')}}
                                        <strong> <span
                                                class="badge badge-warning">{{ $countries->firstItem() }}</span></strong>
                                        {{__('global.to')}}
                                        <strong> <span
                                                class="badge badge-warning">{{$countries->lastItem() }}</span></strong>
                                        ({{__('global.sum')}}
                                        <strong> <span
                                                class="badge badge-danger">{{ $countries->total() }}</span></strong>
                                        {{__('global.records')}})
                                    </div>
                                </div>
                                <!-- Page end =============================================================================================== -->
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <table id="example2" class="table_grid">
                                            ...
                                            @foreach($countries as $country)
                                                                                        <tr>
                                                    <td>{!! highlightSearch($country->id, 'id', $global_style_search) !!}</td>
                                                    <td>{!! highlightSearch($country->name, 'name', $global_style_search) !!}</td>
                                                    <td class="text-center">{{ $country->code_s   }}</td>
                                                    <td class="text-center">{{ $country->users_count   }}</td>
                                                    <td class="text-center">{{ $country->records_count    }}</td>
                                                    <td>
                                                        <div class="btn-group btn-group-sm">
                                                            {{-------------------------------------------------------------------------------------------------------}}
                                                            <button class="btn btn-info"
                                                                    onclick="getContentID('{{$url_show.'/'. $country->id }}','ModalShow','{{ $module->title}}')">
                                                                <i class="fas fa-eye"
                                                                   title="{{__('global.show_hint')}}"></i></button>
                                                            {{-------------------------------------------------------------------------------------------------------}}

                                                                {{-------------------------------------------------------------------------------------------------------}}
                                                                <a href="{{$url_edit.'/'.$country->id.'?'.$query }}"
                                                                ...
                                                                <a href="#" class="btn btn-danger modal_warning"
                                                                   ...
                                                                   data-url="{{$url_delete.'/'.$country->id.'?'.$query }}"

                                                                   data-content_l="id: {{$country->id}}, "
                                                                   data-content_b="{{ $country->name}}, "
                                                                   data-content_sub_l="{{ $country->code}}"
                                                                   data-content_sub_b=""
